...
def train_sentiment_analysis(args):
    ...
    print(tsvPth_train)
    entity_property_train_data = get_dataset("../../../dataset/task_ABSA/nikluge-sa-2022-train.jsonl", tokenizer)
    entity_property_dev_data = get_dataset("../../../dataset/task_ABSA/nikluge-sa-2022-dev.jsonl", tokenizer)
